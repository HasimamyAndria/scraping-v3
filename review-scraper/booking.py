...
class Booking_ES(Booking):
    def __init__(self, url: str, establishment: str, establishment_name: str, settings: str, env: str):
        super().__init__(url=url, establishment=establishment,establishment_name=establishment_name, settings=settings, env=env)
        self.lang = "es"
