...
class Tripadvisor(Scraping):
    def __init__(self, url: str, establishment: str, source: str,settings: str, env: str):
        super().__init__(in_background=False, url=url,
                         establishment=establishment, source=source,settings=settings, env=env, force_refresh=True)
...
class Tripadvisor_FR(Tripadvisor):
    def __init__(self, url: str, establishment: str, source: str,settings: str, env: str):
        super().__init__(url=url, establishment=establishment,source=source, settings=settings, env=env)
