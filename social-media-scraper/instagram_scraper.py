...
class InstagramProfileScraper(Scraping):
    ...
    def goto_login(self) -> None:
        try:
            ...
            self.log_error(f"Error going to login page: {e}")
            raise
            ...
            try:    
                ...
                if 'comments/' in response.url:
                    try:
                        ...
                        self.log_error(f"Error process in comments response: {e} ")
                        print(e)
                        pass
            except Exception as e:
                self.log_error(f"Error in response interception: {e}")  
    ...
    def open_posts(self):
        ...
        try:
            ...
            self.log_error(f"Error clicking on first post: {e}")
            print(e)
            pass
    ...
    def complete_source_data(self):
        ...
        for index in range(len(coms)):
            try:
                ...
                self.log_error(f"Error matching comments to posts: {e}")
                print(e)
                pass
    ...
    def scroll_down_page(self) -> None:
        for i in range(5):
            try:
                ...
                self.log_error(f"Error scrolling down the page : {e}")
    ...
    def extract_data(self) -> None:
        ...
        for post in posts:
            ...
            if type(post["comments"]) != list:
                ...
                try:
                    ...
                    self.log_error(f"Error processing post: {e}")
                    print(e)
                    pass
        ...
        try:
            ...
            self.log_error(f"Error extracting page data: {e}")
            print(e)
            pass
